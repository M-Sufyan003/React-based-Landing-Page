            ...
            <div className="hero-div-CTA">
              ...
              <div className="playDemo">
                <button className="play-button">
                  <FaPlay size={12} className="icon"/>
                </button>
                <div className="playdemoText">play Demo</div>
              </div>
            </div>
          </div>
